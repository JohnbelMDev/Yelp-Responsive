...
// normal routes ===============================================================
   ...
   app.delete('/deleteDonation',(request,responce) =>{
console.log(request.body.id);
     db.collection('donation').findOneAndDelete({
       _id: new mongoose.mongo.ObjectID(request.body.id),
       }, (err, result) => {
  ...
  app.post('/fundRaiser', (request, responce) =>{
    ...
    // intialize
    let date = new Date();
    let fund =parseInt(request.body.fund);
    // const sleep = 8;
